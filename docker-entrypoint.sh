...
seed_workspace_prompt_files() {
  workspace_root="$1"
  templates_root="$2"

  [ -d "$templates_root" ] || return 0

  copy_file_if_missing "${templates_root}/AGENTS.md" "${workspace_root}/AGENTS.md"
  copy_file_if_missing "${templates_root}/SOUL.md" "${workspace_root}/SOUL.md"
  copy_file_if_missing "${templates_root}/TOOLS.md" "${workspace_root}/TOOLS.md"
  copy_file_if_missing "${templates_root}/IDENTITY.md" "${workspace_root}/IDENTITY.md"
  copy_file_if_missing "${templates_root}/USER.md" "${workspace_root}/USER.md"
  copy_file_if_missing "${templates_root}/HEARTBEAT.md" "${workspace_root}/HEARTBEAT.md"
  copy_file_if_missing "${templates_root}/BOOTSTRAP.md" "${workspace_root}/BOOTSTRAP.md"
}
...
for _env_name in \
  ...
  NULLCLAW_WORKSPACE_TEMPLATE_DIR \
...
NULLCLAW_WORKSPACE_TEMPLATE_DIR="${NULLCLAW_WORKSPACE_TEMPLATE_DIR:-/opt/nullclaw/workspace_templates}"
...
seed_workspace_prompt_files "$WORKSPACE_DIR" "$NULLCLAW_WORKSPACE_TEMPLATE_DIR"
